...
const _excluded = ["timeIcon", "hidden", "className", "sx", "classes"];
...
const TimeRangePickerTabs = exports.TimeRangePickerTabs = function TimeRangePickerTabs(inProps) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(TimeRangePickerTabsRoot, (0, _extends2.default)({}, other, {
    variant: "fullWidth",
    value: rangePosition,
...
process.env.NODE_ENV !== "production" ? TimeRangePickerTabs.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
