...
const DataGridProRaw = (0, _forwardRef.forwardRef)(function DataGridPro(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_xDataGrid.GridContextProvider, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_xDataGrid.GridRoot, (0, _extends2.default)({
      ...
      ref: ref,
      children: [watermark, /*#__PURE__*/(0, _jsxRuntime.jsx)(_GridMultiSelectMeasurer.GridMultiSelectMeasurer, {})]
    }))
  });
});
...
process.env.NODE_ENV !== "production" ? DataGridProRaw.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
