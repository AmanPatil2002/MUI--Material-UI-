...
import type { GridKeyValue, GridRowId, GridRowTreeConfig } from '@mui/x-data-grid';
import type { GridPrivateApiPro } from "../../../models/index.mjs";
import type { GridGetRowsParamsPro } from "./models.mjs";
...
export declare class NestedDataManager {
  ...
  queue: (ids: GridRowId[], fetchParams: GridGetRowsParamsPro[], showChildrenLoading?: boolean) => Promise<void>;
