 ...
 */
export declare const DEFAULT_OVERFLOW_CHIP_WIDTHS: number[];
 ...
 */
export declare function getOverflowChipWidth(hiddenCount: number, widths?: number[]): number;
/**
 ...
 */
export declare function calculateVisibleCount(arrayLength: number, containerWidth: number, chipWidths: Map<number, number>, overflowChipWidths?: number[], gap?: number): number;