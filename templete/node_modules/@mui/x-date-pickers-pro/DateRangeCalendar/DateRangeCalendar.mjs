...
const DateRangeCalendar = /*#__PURE__*/React.forwardRef(function DateRangeCalendar(inProps, ref) {
  ...
  React.useEffect(() => {
    ...
    const currentMonthIndex = adapter.getYear(calendarState.currentMonth) * 12 + adapter.getMonth(calendarState.currentMonth);
    ...
    if (requestedMonthIndex < firstVisibleMonthIndex || requestedMonthIndex > lastVisibleMonthIndex) {
...
process.env.NODE_ENV !== "production" ? DateRangeCalendar.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
