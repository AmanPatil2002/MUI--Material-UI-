...
const useGridDataSourceBasePro = (apiRef, props, options = {}) => {
  ...
  const fetchRowChildren = React.useCallback(async (id, argParams) => {
    ...
    const fetchParams = (0, _extends2.default)({}, (0, _internals.gridGetRowsParamsSelector)(apiRef), pipedParams, argParams, {
    ...
    try {
      ...
      if (!(0, _xDataGrid.gridRowNodeSelector)(apiRef, id)) {
  ...
  return {
    ...
    nestedDataStrategyProcessor: {
      strategyName: _internals.DataSourceRowsUpdateStrategy.GroupedData,
      group: 'dataSourceNestedRowsUpdate',
