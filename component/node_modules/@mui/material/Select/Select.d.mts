...
import { SelectChangeEvent, SelectInputProps } from "./SelectInput.mjs";
import { SelectClasses } from "./selectClasses.mjs";
...
export interface FilledSelectProps extends Omit<FilledInputProps, 'value' | 'onChange' | 'id' | 'classes' | 'inputProps' | 'placeholder' | 'label'> {
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
export interface StandardSelectProps extends Omit<InputProps, 'value' | 'onChange' | 'id' | 'classes' | 'inputProps' | 'placeholder' | 'label'> {
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
export interface OutlinedSelectProps extends Omit<OutlinedInputProps, 'value' | 'onChange' | 'id' | 'classes' | 'inputProps' | 'placeholder' | 'label'> {
  /**
   * The variant to use.
   * @default 'outlined'
   */
