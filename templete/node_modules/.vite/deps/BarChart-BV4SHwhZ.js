...
import { $ as useBarSeriesContext, A as useAnimateBarLabel, Ft as useDrawingArea, G as selectorChartSeriesHighlightedItem, H as useItemHighlightState, It as useStore, K as selectorChartSeriesUnfadedItem, Lt as useChartsContext, N as useAnimate, P as ANIMATION_TIMING_FUNCTION, Pt as useChartId, St as useXAxes, U as selectorChartIsSeriesFaded, W as selectorChartIsSeriesHighlighted, Xt as selectorChartsItemIsFocused, ct as useChartsLayerContainerRef, er as DEFAULT_X_AXIS_KEY, j as useAnimateBar, jn as selectorChartSeriesConfig, on as selectorChartZoomMap, p as useFocusedItem, sn as selectorChartZoomOptionsLookup, tr as DEFAULT_Y_AXIS_KEY, vn as selectorChartDrawingArea, wt as useYAxes, zn as number_default } from "./hooks-CYJjzrvT.js";
import { A as useSkipAnimation, Ct as useChartCartesianAxis, D as createGetBucketBarDimensions, E as createGetBarDimensions, F as ChartsTooltip, Lt as useChartVisibilityManager, Mt as getChartPoint, O as getColor, Pt as useChartZAxis, St as useChartBrush, T as ChartsOverlay, _t as useChartHighlight, bt as useChartTooltip, i as ChartsSurface, j as ChartsLegend, jt as useChartInteraction, l as ChartsDataProvider, r as useChartsContainerProps, t as ChartsWrapper, xt as selectorBarItemAtPosition, yt as useChartKeyboardNavigation } from "./ChartsWrapper-XBLrLLWB.js";
...
import { a as ChartsGrid, g as selectorChartSamplingPyramids, h as getFullRangeZoom, m as ChartsClipPath, n as ChartsAxisHighlight, s as ChartsAxis, t as useInternalIsZoomInteracting } from "./useInternalIsZoomInteracting-bLeFoCOE.js";
...
function useBarPlotData(drawingArea, xAxes, yAxes) {
	...
	return import_react.useMemo(() => processBarDataForPlot(drawingArea, chartId, seriesData.stackingGroups, seriesData.series, xAxes, yAxes, defaultXAxisId, defaultYAxisId, samplingPyramids, zoomMap, sampler, zoomOptions), [
		drawingArea,
		chartId,
		...
		completedData: stackingGroups.flatMap(({ ids: seriesIds }, groupIndex) => {
			...
			return seriesIds.map((seriesId) => {
				...
				const registerResult = (result, dataIndex) => {
					if (result.x > xMax || result.x + result.width < xMin || result.y > yMax || result.y + result.height < yMin) return;
				...
				const zoom = zoomMap?.get(baseAxisId) ?? (pyramid ? getFullRangeZoom(baseAxisId) : void 0);
				...
				if (sampledBuckets) {
					...
					for (const { startIndex, endIndex, indices } of sampledBuckets) {
						...
						registerResult(makeResult(startIndex, getBucketBarDimensions(startIndex, endIndex, low, high, groupIndex)), startIndex);
					}
				} else {
...
//#endregion
export { appendAtKey as a, barClasses as c, BarPlot as i, FocusedBar as n, BarElement as o, BAR_CHART_PLUGINS as r, BarLabel as s, BarChart as t };
